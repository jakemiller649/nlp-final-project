"""My corpus has contractions; my pretrained word embeddings do not. As such
I am making an assumption: converting contractions to their forms. In the process of searching
for a list of common contractions, I came across the linked webpage below and copied its dict of
contractions for my use. I then added a couple more that I found in the course of my debugging.
...
contractions = {"ain't": "is not", "aren't": "are not","can't": "cannot",
                ...
                "'kay": "okay", "that'll": "that will", "'til": "until", "'em": "them"}
